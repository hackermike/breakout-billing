...
- **Email reminders** — opt clients in per person; a "Reminders due" panel sends the next couple of days' appointment reminders (previewed until you configure SMTP).
